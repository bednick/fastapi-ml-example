...
class Settings(pydantic_settings.BaseSettings):
    ...
    project_name: str = pydantic.Field("fastapi-ml-example", validation_alias="PROJECT_NAME")
    version: str = pydantic.Field("latest", validation_alias="VERSION")
    debug: bool = pydantic.Field(False, validation_alias="DEBUG")

    process_pool_executor_size: int = pydantic.Field(4, validation_alias="PROCESS_POOL_EXECUTOR_SIZE")
